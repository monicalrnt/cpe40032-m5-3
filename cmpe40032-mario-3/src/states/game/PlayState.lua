...
function PlayState:init()
	...
	-- grp 3 - Time until victory state and game over state
	self.victoryTimer = 0
...
-- grp3 - Allows passing in level for efficiency and less jarring visuals
...
function PlayState:enter(params)
	...
	-- grp3.1 - Finding a non-chasm to drop player
	self.drop = 0
	...
	self.player = Player({
		-- grp3.1 - Dropping player at the drop column
	...
	self.player:changeState('falling', {vSpur = PLAYER_WALK_SPEED})
