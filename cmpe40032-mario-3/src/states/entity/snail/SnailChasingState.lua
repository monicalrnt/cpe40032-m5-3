...
function SnailChasingState:init(tilemap, player, snail)
	...
	self.player = player
	self.snail = snail
	-- grp3 - Support for multiple snail types
	...
	-- grp3 - Frames of lag while turning to avoid jarring dash-dance.
end
...
elseif (self.player.x + self.player.width / 2 < self.snail.x + self.snail.width / 2 and self.snail.direction == 'right') or
	...
	-- grp3 - separated this logic to be seperate from snail turning logic
